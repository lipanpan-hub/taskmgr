...
running command...
$ tm (--version)
@lppx/taskmgr/1.0.2 win32-x64 node-v24.11.0
$ tm --help [COMMAND]
USAGE
  $ tm COMMAND
...
...
_See code: [src/commands/scripts/add.ts](https://github.com/lipanpan-hub/taskmgr/blob/v1.0.2/src/commands/scripts/add.ts)_
...
_See code: [src/commands/scripts/list.ts](https://github.com/lipanpan-hub/taskmgr/blob/v1.0.2/src/commands/scripts/list.ts)_
...
_See code: [src/commands/scripts/open.ts](https://github.com/lipanpan-hub/taskmgr/blob/v1.0.2/src/commands/scripts/open.ts)_
...
_See code: [src/commands/tsk/add.ts](https://github.com/lipanpan-hub/taskmgr/blob/v1.0.2/src/commands/tsk/add.ts)_
...
_See code: [src/commands/tsk/del.ts](https://github.com/lipanpan-hub/taskmgr/blob/v1.0.2/src/commands/tsk/del.ts)_
...
_See code: [src/commands/tsk/list.ts](https://github.com/lipanpan-hub/taskmgr/blob/v1.0.2/src/commands/tsk/list.ts)_
...
_See code: [src/commands/ui/index.ts](https://github.com/lipanpan-hub/taskmgr/blob/v1.0.2/src/commands/ui/index.ts)_
